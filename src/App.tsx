...
import type { Artist, Gig, Tip, Request, RequestPreferences } from './components/AppContext';
...
import { AppContext, type AppContextType } from './components/AppContext';
...
export default function App() {
  ...
  const [requestPreferences, setRequestPreferences] = useState<RequestPreferences>({
